      ...
      <table id="products_table" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src='../assets/admin/images/products/<?php echo $product['image'];?>' class="img-responsive"></td>
            <td><?php echo ucfirst($product['price']);?></td>
            <td><?php if($product['status'] == 1){ echo 'Active';}else{ echo 'Inactive'; }?></td>
            <?php if (has_permissions('products','edit') || has_permissions('products','delete')) { ?>
            <td class="text-center">
              <?php if (has_permissions('products','edit')) { ?>
                <a data-popup="tooltip" data-placement="top"  title="<?php _el('edit') ?>" href="<?php echo site_url('admin/products/edit/').$product['id']; ?>" id="<?php echo $product['id']; ?>" class="text-info">
