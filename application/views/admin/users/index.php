            ...
            <table id="users_table" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th width="8%" class="text-center">is_email_verified</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($user['role'] == 1){ echo 'Admin'; }else { echo 'User'; } ?>
                        </td>

                        <td>
                           <?php echo ucfirst($user['mobile_no']).'&nbsp;'.ucfirst($user['mobile_no']); ?>
                        </td>
                        ...
                        <td class="text-center switchery-sm">
                          <?php if ($user['is_email_verified'] == 1) { echo "Verified"; }else { echo "unverified"; } ?>
                        </td>
